...
namespace Engine.Core.Interfaces
{
    public class ImGuiController : IDisposable
    {
        ...
        // Modify existing Dispose method to call new protected Dispose method
        public void Dispose()
        {
            Dispose(true);
        ...
        // Add protected virtual Dispose method
        ...
        // Add check for disposed state to public methods
        ...
        // Add helper method to check disposed state
        private void ThrowIfDisposed()
        {
            if (_disposed)
            {
                throw new ObjectDisposedException(nameof(ImGuiController));
            }
        }

        // Update DestroyDeviceObjects to use Dispose
...
void main()
{
    outputColor = color * texture(in_fontTexture, texCoord);
        ...
        public static void CheckGLError(string title)
        {
            ErrorCode error;
            int i = 1;
            while ((error = (ErrorCode)GL.GetError()) != ErrorCode.NoError)
            {
